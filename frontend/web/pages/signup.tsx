        ...
        <ul>
          ...
          <Row>
            <div onChange={e => onInput('role_id', parseInt(e.target.value))}>
              ...
              <OptionInput id="role-2" type="radio" value="4" name="role" />
              <OptionLabel focus={state.role_id == '4'} htmlFor="role-2">
                RST管理员
              </OptionLabel>
              <OptionInput id="role-1" type="radio" value="2" name="role" />
              <OptionLabel focus={state.role_id == '2'} htmlFor="role-1">
                用户管理员
              </OptionLabel>
            </div>
          </Row>
